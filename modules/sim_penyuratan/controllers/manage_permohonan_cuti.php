...
/**
 * Description of Manage_Permohonan_Cuti
 *
 * @author No-CMS Module Generator
 */
class Manage_Permohonan_Cuti extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/manage_permohonan_cuti_view', $output,
            $this->cms_complete_navigation_name('manage_permohonan_cuti'));
